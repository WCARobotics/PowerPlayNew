 ...
 public class GenericDetector implements Runnable{
     ...
     private String modelFileName = "model_unquant";//"croppedRingRec.tflite";
     private String labelFileName = "labels";//"croppedLabels.txt";
     private static Classifier.Model MODEl_TYPE = Classifier.Model.FLOAT_EFFICIENTNET;
     private static final String LABEL_A = "Three";
     private static final String LABEL_B = "One";
     private static final String LABEL_C = "Two";
