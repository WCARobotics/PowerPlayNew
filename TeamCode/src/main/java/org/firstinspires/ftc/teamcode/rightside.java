...
public class rightside extends LinearOpMode {
    ...
    public CRServo claw;
    public DistanceSensor rightSensor, backSensor;
    ...
    public void runOpMode () {
        ...
        waitForStart();
        while(rightSensor.getDistance(DistanceUnit.INCH) < 35){
            move(-0.75, 0.75, 0.75, -0.75, 1000);
        }
        while(backSensor.getDistance(DistanceUnit.INCH) < 50){
            move(0.75, 0.75, 0.75, 0.75, 1000);
        }
        move(-0.75, -0.75, 0.75, 0.75, 1000);
        /*while(leftSensor.getDistance(DistanceUnit.INCH)< 36){
            move(move(0.75, -0.75, -0.75, 0.75, 1000);
        }
         */
    }
